...
deceased_cutoff = 17. # smaller sample--less variation close to the median
survivors_cutoff = 50. 

survivors_processor = PostprocessorTrim(model_type, DATA_SURVIVORS_PATH, DESTINATION_SURVIVORS_PATH, survivors_cutoff)
deceased_processor = PostprocessorTrim(model_type, DATA_DECEASED_PATH, DESTINATION_DECEASED_PATH, deceased_cutoff)
