...
if __name__ == "__main__":
    ...
    # This is plotting genes most expressed
    plt.figure(figsize=(20, 15))
    plt.barh(range(feat_impo_size), combined_data.columns[sorted_gene_expr][:feat_impo_size], align='center')
    plt.yticks(range(feat_impo_size), combined_data.columns[sorted_gene_expr][:feat_impo_size])
    plt.xlabel('Feature Importance')
    plt.ylabel('Genes')
    plt.title('50 Most Expressed Genes')
